...
|-----------|-------------------|----------|-------------|--------------------|------------|
| Clinical Foundation | MIMIC-IV Notes | Medical terminology and clinical language understanding | Restricted Public | PhysioNet account, CITI Training, DUA acceptance | [PhysioNet](https://physionet.org/content/mimiciv) |
| Clinical Summarization | MIMIC-IV Ext-BHC | Clinical summarization training | Restricted Public | PhysioNet account, CITI Training, DUA acceptance | [PhysioNet](https://physionet.org) |
| Medical Conversations | MedDialog | Healthcare conversational patterns | Public | None | [GitHub](https://github.com/UCSD-AI4H/Medical-Dialogue-System) |
| Medical Entity Recognition | MedMentions | Medical entity extraction | Public | None | [GitHub](https://github.com/chanzuckerberg/MedMentions) |
| Clinical NLP | n2c2 Clinical NLP Datasets | Clinical entity extraction and relation modeling | Restricted Research | DUA and approval required | [n2c2 Portal](https://portal.dbmi.hms.harvard.edu/projects/n2c2-nlp) |
| Clinical NLP | i2b2 Datasets | Clinical NLP benchmarking | Restricted Research | Registration and DUA | [i2b2](https://www.i2b2.org) |
| Clinical QA | MedQA | Medical reasoning evaluation | Public | None | [GitHub](https://github.com/jind11/MedQA) |
| Clinical QA | PubMedQA | Biomedical QA evaluation | Public | None | [PubMedQA](https://pubmedqa.github.io) |
| Claims Intelligence | HCUP NIS | Claims and coding intelligence | Restricted Commercial | HCUP DUA and training course | [HCUP](https://hcup-us.ahrq.gov) |
| Denial Intelligence | CMS CARC Codes | Claim denial interpretation | Public | None | [CMS HCPCS](https://www.cms.gov/medicare/coding-billing/healthcare-common-procedure-system) |
| Remittance Intelligence | CMS RARC Codes | Remittance explanation reasoning | Public | None | [CMS Coding & Billing](https://www.cms.gov/medicare/coding-billing) |
| Coverage Policies | CMS NCD/LCD Database | Coverage determination retrieval | Public | None | [Medicare Coverage Database](https://www.cms.gov/medicare-coverage-database) |
| Regulatory Knowledge | HIPAA Regulations | Compliance validation | Public | None | [HHS HIPAA](https://www.hhs.gov/hipaa) |
| Regulatory Knowledge | CMS Medicare Policies | Policy grounding and retrieval | Public | None | [CMS](https://www.cms.gov) |
| Plan Documents | SBC Samples | Benefits reasoning validation | Public | None | [CMS SBC Resources](https://www.cms.gov/cciio/resources/forms-reports-and-other-resources) |
| Healthcare Foundation Model | Med42-v2 | Healthcare language foundation model | Open Weight | Commercial license review required | [Hugging Face](https://huggingface.co/m42-health/med42-v2-8b) |
